...
def t000001000_x3(actionbutton1=_, flag3=6001, flag4=6000):
	...
	while True:
		...
		"""State 4"""
		if GetEventFlag(flag4) == FlagState.On:
			"""State 5"""
			assert GetEventFlag(flag3) == FlagState.On and not GetEventFlag(flag4)
			"""State 6"""
			assert GetCurrentStateElapsedTime() > 1
		elif GetEventFlag(flag3) == FlagState.On and not GetEventFlag(flag4):
			pass
		"""State 3"""
		if CompareBonfireState(0):
			...
			break
			  ...
			  IsCharacterDisabled())):
			pass
		elif not GetEventFlag(flag3) or GetEventFlag(flag4) == FlagState.On:
			pass
	"""State 7"""
	return 0
...
def t000001000_x5(actionbutton5=6100, flag1=6001, flag2=6000):
	...
	while True:
		...
		assert not GetOneLineHelpStatus() and not IsClientPlayer() and not IsPlayerDead() and not IsCharacterDisabled()
		"""State 3"""
		assert GetEventFlag(flag1) == FlagState.On and not GetEventFlag(flag2)
		"""State 2"""
		...
		if CheckActionButtonArea(actionbutton5):
			break
			  ...
			  IsCharacterDisabled())):
			pass
		elif not GetEventFlag(flag1) or GetEventFlag(flag2) == FlagState.On:
			pass
	"""State 4"""
	return 0
...
def t000001000_x6(goods7=1000, goods8=10020):
	"""State 0,14"""
	if GetEventFlag(720080) == FlagState.On:
		"""State 15"""
		pass
	else:
		"""State 16,17"""
	...
	if GetTotalBonfireLevel() <= 13:
		...
		if call.Get() == 0:
			...
			if call.Get() == 0:
				...
				if ComparePlayerInventoryNumber(ItemType.Goods, goods8, CompareType.GreaterOrEqual, GetWorkValue(1), false) == 1:
					"""State 4,8"""
...
def t000001000_x7(goods5=1000, goods6=10010):
	"""State 0,15"""
	if GetEventFlag(720070) == FlagState.On:
		"""State 16"""
		pass
	else:
		"""State 17,18"""
	...
	if GetEstusAllocation(EstusType.HP) + GetEstusAllocation(EstusType.FP) < 13:
		...
		if call.Get() == 0:
			...
			if call.Get() == 0:
				...
				if ComparePlayerInventoryNumber(ItemType.Goods, goods6, CompareType.GreaterOrEqual, GetWorkValue(1), false) == 1:
					"""State 4,8"""
					# goods:10010:Golden Seed
...
def t000001000_x8(goods11=1000):
	...
	if DoesPlayerHaveItem(ItemType.Goods, goods11 + 1 + 0 * 50 + 0 * 2) == 1 or DoesPlayerHaveItem(ItemType.Goods, goods11 + 0 + 0 * 50 + 0 * 2) == 1:
		"""State 2"""
		BonfireActivation(1)
		"""State 13"""
		Label('L0')
	...
	elif DoesPlayerHaveItem(ItemType.Goods, goods11 + 1 + 0 * 50 + 1 * 2) == 1 or DoesPlayerHaveItem(ItemType.Goods, goods11 + 0 + 0 * 50 + 1 * 2) == 1:
		"""State 3"""
		BonfireActivation(2)
		Goto('L0')
	# goods:1005:Flask of Crimson Tears +2, goods:1004:Flask of Crimson Tears +2
	elif DoesPlayerHaveItem(ItemType.Goods, goods11 + 1 + 0 * 50 + 2 * 2) == 1 or DoesPlayerHaveItem(ItemType.Goods, goods11 + 0 + 0 * 50 + 2 * 2) == 1:
		"""State 4"""
		BonfireActivation(3)
		Goto('L0')
	# goods:1007:Flask of Crimson Tears +3, goods:1006:Flask of Crimson Tears +3
	elif DoesPlayerHaveItem(ItemType.Goods, goods11 + 1 + 0 * 50 + 3 * 2) == 1 or DoesPlayerHaveItem(ItemType.Goods, goods11 + 0 + 0 * 50 + 3 * 2) == 1:
		"""State 5"""
		BonfireActivation(4)
		Goto('L0')
	# goods:1009:Flask of Crimson Tears +4, goods:1008:Flask of Crimson Tears +4
	elif DoesPlayerHaveItem(ItemType.Goods, goods11 + 1 + 0 * 50 + 4 * 2) == 1 or DoesPlayerHaveItem(ItemType.Goods, goods11 + 0 + 0 * 50 + 4 * 2) == 1:
		"""State 6"""
		BonfireActivation(5)
		Goto('L0')
	# goods:1011:Flask of Crimson Tears +5, goods:1010:Flask of Crimson Tears +5
	elif DoesPlayerHaveItem(ItemType.Goods, goods11 + 1 + 0 * 50 + 5 * 2) == 1 or DoesPlayerHaveItem(ItemType.Goods, goods11 + 0 + 0 * 50 + 5 * 2) == 1:
		"""State 7"""
		BonfireActivation(6)
		Goto('L0')
	# goods:1013:Flask of Crimson Tears +6, goods:1012:Flask of Crimson Tears +6
	elif DoesPlayerHaveItem(ItemType.Goods, goods11 + 1 + 0 * 50 + 6 * 2) == 1 or DoesPlayerHaveItem(ItemType.Goods, goods11 + 0 + 0 * 50 + 6 * 2) == 1:
		"""State 8"""
		BonfireActivation(7)
		Goto('L0')
	# goods:1015:Flask of Crimson Tears +7, goods:1014:Flask of Crimson Tears +7
	elif DoesPlayerHaveItem(ItemType.Goods, goods11 + 1 + 0 * 50 + 7 * 2) == 1 or DoesPlayerHaveItem(ItemType.Goods, goods11 + 0 + 0 * 50 + 7 * 2) == 1:
		"""State 9"""
		BonfireActivation(8)
		Goto('L0')
	# goods:1017:Flask of Crimson Tears +8, goods:1016:Flask of Crimson Tears +8
	elif DoesPlayerHaveItem(ItemType.Goods, goods11 + 1 + 0 * 50 + 8 * 2) == 1 or DoesPlayerHaveItem(ItemType.Goods, goods11 + 0 + 0 * 50 + 8 * 2) == 1:
		"""State 10"""
		BonfireActivation(9)
		Goto('L0')
	# goods:1019:Flask of Crimson Tears +9, goods:1018:Flask of Crimson Tears +9
	elif DoesPlayerHaveItem(ItemType.Goods, goods11 + 1 + 0 * 50 + 9 * 2) == 1 or DoesPlayerHaveItem(ItemType.Goods, goods11 + 0 + 0 * 50 + 9 * 2) == 1:
		"""State 11"""
		BonfireActivation(10)
		Goto('L0')
	# goods:1021:Flask of Crimson Tears +10, goods:1020:Flask of Crimson Tears +10
	elif DoesPlayerHaveItem(ItemType.Goods, goods11 + 1 + 0 * 50 + 10 * 2) == 1 or DoesPlayerHaveItem(ItemType.Goods, goods11 + 0 + 0 * 50 + 10 * 2) == 1:
		"""State 12"""
	...
	elif DoesPlayerHaveItem(ItemType.Goods, goods11 + 1 + 0 * 50 + 11 * 2) == 1 or DoesPlayerHaveItem(ItemType.Goods, goods11 + 0 + 0 * 50 + 11 * 2) == 1:
		"""State 16"""
		BonfireActivation(12)
		Goto('L0')
	# goods:1025:Flask of Crimson Tears +12, goods:1024:Flask of Crimson Tears +12
	elif DoesPlayerHaveItem(ItemType.Goods, goods11 + 1 + 0 * 50 + 12 * 2) == 1 or DoesPlayerHaveItem(ItemType.Goods, goods11 + 0 + 0 * 50 + 12 * 2) == 1:
		"""State 17"""
...
def t000001000_x12(goods11=1000, goods12=_, goods13=_):
	...
	if (not DoesPlayerHaveItem(ItemType.Goods, goods11 + goods13 + goods12 * 50 + 0 * 2) and not DoesPlayerHaveItem(ItemType.Goods,
		goods11 + goods13 + goods12 * 50 + 1 * 2) and not DoesPlayerHaveItem(ItemType.Goods, goods11 + goods13 + goods12
		* 50 + 2 * 2) and not DoesPlayerHaveItem(ItemType.Goods, goods11 + goods13 + goods12 * 50 + 3 * 2) and not
		DoesPlayerHaveItem(ItemType.Goods, goods11 + goods13 + goods12 * 50 + 4 * 2) and not DoesPlayerHaveItem(ItemType.Goods,
		goods11 + goods13 + goods12 * 50 + 5 * 2) and not DoesPlayerHaveItem(ItemType.Goods, goods11 + goods13 + goods12
		* 50 + 6 * 2) and not DoesPlayerHaveItem(ItemType.Goods, goods11 + goods13 + goods12 * 50 + 7 * 2)):
		"""State 2,3"""
		return 0
	else:
		"""State 4"""
...
def t000001000_x13():
	"""State 0,1"""
	if DoesPlayerHaveSpEffect(8990) == true:
		"""State 2"""
...
def t000001000_x14(text1=_, z54=_, mode3=1):
	"""State 0,5"""
	assert t000001000_x2() and CheckSpecificPersonTalkHasEnded(0) == true
	"""State 1"""
	TalkToPlayer(text1, -1, -1, 0)
	assert CheckSpecificPersonTalkHasEnded(0) == true
	"""State 4"""
	if not mode3:
		pass
	else:
...
def t000001000_x17(goods7=1000, goods10=_, z53=1):
	"""State 0,13"""
	SetWorkValue(z53, 0)
	if (DoesPlayerHaveItem(ItemType.Goods, goods7 + 0 + goods10 * 50 + 0 * 2) == 1 or DoesPlayerHaveItem(ItemType.Goods, goods7
		+ 1 + goods10 * 50 + 0 * 2) == 1):
		"""State 1"""
		SetWorkValue(z53, 0)
	elif (DoesPlayerHaveItem(ItemType.Goods, goods7 + 0 + goods10 * 50 + 1 * 2) == 1 or DoesPlayerHaveItem(ItemType.Goods, goods7
		  + 1 + goods10 * 50 + 1 * 2) == 1):
		"""State 2"""
		SetWorkValue(z53, 1)
	elif (DoesPlayerHaveItem(ItemType.Goods, goods7 + 0 + goods10 * 50 + 2 * 2) == 1 or DoesPlayerHaveItem(ItemType.Goods, goods7
		  + 1 + goods10 * 50 + 2 * 2) == 1):
		"""State 3"""
		SetWorkValue(z53, 2)
	elif (DoesPlayerHaveItem(ItemType.Goods, goods7 + 0 + goods10 * 50 + 3 * 2) == 1 or DoesPlayerHaveItem(ItemType.Goods, goods7
		  + 1 + goods10 * 50 + 3 * 2) == 1):
		"""State 4"""
		SetWorkValue(z53, 3)
	elif (DoesPlayerHaveItem(ItemType.Goods, goods7 + 0 + goods10 * 50 + 4 * 2) == 1 or DoesPlayerHaveItem(ItemType.Goods, goods7
		  + 1 + goods10 * 50 + 4 * 2) == 1):
		"""State 5"""
		SetWorkValue(z53, 4)
	elif (DoesPlayerHaveItem(ItemType.Goods, goods7 + 0 + goods10 * 50 + 5 * 2) == 1 or DoesPlayerHaveItem(ItemType.Goods, goods7
		  + 1 + goods10 * 50 + 5 * 2) == 1):
		"""State 6"""
		SetWorkValue(z53, 5)
	elif (DoesPlayerHaveItem(ItemType.Goods, goods7 + 0 + goods10 * 50 + 6 * 2) == 1 or DoesPlayerHaveItem(ItemType.Goods, goods7
		  + 1 + goods10 * 50 + 6 * 2) == 1):
		"""State 7"""
		SetWorkValue(z53, 6)
	elif (DoesPlayerHaveItem(ItemType.Goods, goods7 + 0 + goods10 * 50 + 7 * 2) == 1 or DoesPlayerHaveItem(ItemType.Goods, goods7
		  + 1 + goods10 * 50 + 7 * 2) == 1):
		"""State 8"""
		SetWorkValue(z53, 7)
	elif (DoesPlayerHaveItem(ItemType.Goods, goods7 + 0 + goods10 * 50 + 8 * 2) == 1 or DoesPlayerHaveItem(ItemType.Goods, goods7
		  + 1 + goods10 * 50 + 8 * 2) == 1):
		"""State 9"""
		SetWorkValue(z53, 8)
	elif (DoesPlayerHaveItem(ItemType.Goods, goods7 + 0 + goods10 * 50 + 9 * 2) == 1 or DoesPlayerHaveItem(ItemType.Goods, goods7
		  + 1 + goods10 * 50 + 9 * 2) == 1):
		"""State 10"""
		SetWorkValue(z53, 9)
	elif (DoesPlayerHaveItem(ItemType.Goods, goods7 + 0 + goods10 * 50 + 10 * 2) == 1 or DoesPlayerHaveItem(ItemType.Goods, goods7
		  + 1 + goods10 * 50 + 10 * 2) == 1):
		"""State 11"""
		SetWorkValue(z53, 10)
	elif (DoesPlayerHaveItem(ItemType.Goods, goods7 + 0 + goods10 * 50 + 11 * 2) == 1 or DoesPlayerHaveItem(ItemType.Goods, goods7
		  + 1 + goods10 * 50 + 11 * 2) == 1):
		"""State 14"""
		SetWorkValue(z53, 11)
	elif (DoesPlayerHaveItem(ItemType.Goods, goods7 + 0 + goods10 * 50 + 12 * 2) == 1 or DoesPlayerHaveItem(ItemType.Goods, goods7
		  + 1 + goods10 * 50 + 12 * 2) == 1):
		"""State 15"""
		SetWorkValue(z53, 12)
	else:
...
def t000001000_x18(goods9=1000, mode2=_, z52=_):
	...
	if not GetEstusAllocation(mode2) < 0:
		"""State 7,12"""
		if (DoesPlayerHaveItem(ItemType.Goods, goods9 + 0 + mode2 * 50 + z52 * 2) == 1 or DoesPlayerHaveItem(ItemType.Goods, goods9
			+ 1 + mode2 * 50 + z52 * 2) == 1):
			"""State 13,1"""
			if DoesPlayerHaveItem(ItemType.Goods, goods9 + 0 + mode2 * 50 + z52 * 2) == 1:
				"""State 2,4"""
			...
			while True:
				"""State 5"""
				if (0 == ComparePlayerInventoryNumber(ItemType.Goods, 1000 + 1 + mode2 * 50 + z52 * 2, CompareType.GreaterOrEqual, GetEstusAllocation(mode2), false)):
					"""State 9,11"""
					PlayerEquipmentQuantityChange(ItemType.Goods, 1000 + 1 + mode2 * 50 + z52 * 2, 1)
				else:
					"""State 10"""
					break
		else:
...
def t000001000_x20(goods7=1000, z51=_):
	"""State 0,1"""
	ReplaceToolIf(DoesPlayerHaveItem(ItemType.Goods, 1000 + 0 + 0 * 50 + z51 * 2) == 1, goods7 + 0 * 50 + z51 * 2 + 0,
				  goods7 + 0 * 50 + 0 + 2 * (GetTotalBonfireLevel() - 1), 1)
	"""State 2"""
	ReplaceToolIf(DoesPlayerHaveItem(ItemType.Goods, 1000 + 1 + 0 * 50 + z51 * 2) == 1, goods7 + 0 * 50 + z51 * 2 + 1,
				  goods7 + 0 * 50 + 1 + 2 * (GetTotalBonfireLevel() - 1), 1)
	"""State 3"""
	ReplaceToolIf(DoesPlayerHaveItem(ItemType.Goods, 1000 + 0 + 1 * 50 + z51 * 2) == 1, goods7 + 1 * 50 + z51 * 2 + 0,
				  goods7 + 1 * 50 + 0 + 2 * (GetTotalBonfireLevel() - 1), 1)
	"""State 4"""
	ReplaceToolIf(DoesPlayerHaveItem(ItemType.Goods, 1000 + 1 + 1 * 50 + z51 * 2) == 1, goods7 + 1 * 50 + z51 * 2 + 1,
...
def t000001000_x22():
	...
	while True:
		"""State 4"""
		if IsMultiplayerInProgress() == true and not GetEventFlag(2051) and not GetEventFlag(2052):
			"""State 6"""
			call = t000001000_x25()
			assert not IsMultiplayerInProgress() or GetEventFlag(2051) == FlagState.On or GetEventFlag(2052) == FlagState.On
		elif GetEventFlag(1042369415) == FlagState.On:
			"""State 7"""
			call = t000001000_x63()
			...
			"""State 5"""
			def WhilePaused():
				GiveSpEffectToPlayerIf(GetEventFlag(9000) == FlagState.On and not GetWorkValue(0), 9607)
...
def t000001000_x23():
	"""State 0,1"""
	if CompareBonfireLevel(5, 0) == true or GetEventFlag(11102790) == FlagState.On:
		"""State 2"""
		Label('L0')
		assert GetWhetherChrEventAnimHasEnded(10000) == true
	else:
		"""State 3,30"""
		call = t000001000_x40()
		if call.Done():
			...
			Goto('L0')
		elif CompareBonfireLevel(5, 0) == true or GetEventFlag(11102790) == FlagState.On:
			pass
	"""State 31"""
	call = t000001000_x40()
	if call.Done():
		...
		SetEventFlagIf(DoesSelfHaveSpEffect(9680) == true and not GetEventFlag(953), 4698, 1)
		SetEventFlagIf(GetEventFlagValue(955, 3) > 2 and DoesSelfHaveSpEffect(9681) == true and not GetEventFlag(953),
					   4698, 1)
		"""State 28"""
		...
		c5_138(GetEventFlag(11102790) == FlagState.On, 1001001)
		...
		if not GetEventFlag(4653):
			...
			if call.Done():
				...
				Goto('L2')
			elif HasPlayerBeenAttacked() == true and GetCurrentStateElapsedFrames() > 1:
				Goto('L2')
			elif (IsMultiplayerInProgress() == true and not GetEventFlag(2051) and not GetEventFlag(2052)
				  and GetCurrentStateElapsedFrames() > 1):
				Goto('L2')
			elif GetEventFlag(1042369415) == FlagState.On and GetCurrentStateElapsedFrames() > 1:
				Goto('L2')
			elif (CompareBonfireLevel(0, 0) == true and not GetEventFlag(11102790) and GetCurrentStateElapsedFrames()
				  > 1):
				Goto('L2')
		else:
			"""State 16,32"""
			...
			if call.Done():
				...
				def ExitPause():
					EndBonfireKindleAnimLoop(GetWorkValue(0))
				Goto('L2')
			elif IsMultiplayerInProgress() == true and GetCurrentStateElapsedFrames() > 1:
				Goto('L3')
			elif HasPlayerBeenAttacked() == true and GetCurrentStateElapsedFrames() > 1:
				Goto('L3')
			elif (((GetDistanceToPlayer() > 3 and not GetEventFlag(11102790)) or GetDistanceToPlayer()
		...
		if not IsMultiplayerInProgress() and not GetEventFlag(1042369415):
			...
			pass
	elif (GetEventFlag(1042369415) == FlagState.On or (CompareBonfireLevel(0, 0) == true and not GetEventFlag(11102790))
		  or (IsMultiplayerInProgress() == true and not GetEventFlag(2051) and not GetEventFlag(2052))):
		pass
	"""State 39"""
	return 0
...
def t000001000_x28():
	...
	if not GetEventFlag(4651):
		"""State 3"""
		if GetEventFlag(4698) == FlagState.On:
			"""State 5,10"""
			assert t000001000_x35(z35=20006, val4=0.5, z36=1, z37=2, z38=60)
		elif GetEventFlag(108) == FlagState.On:
			"""State 9,13"""
...
def t000001000_x30():
	"""State 0"""
	if GetEventFlag(11102790) == FlagState.On:
		"""State 3"""
		pass
	elif GetEventFlag(110) == FlagState.On:
		"""State 1"""
		pass
	elif not GetEventFlag(953) or GetEventFlag(4698) == FlagState.On:
		"""State 4"""
	...
	# eventflag:400001:lot:100010:Rold Medallion
	elif GetEventFlag(11009260) == FlagState.On and not GetEventFlag(400001):
		"""State 6"""
...
def t000001000_x31():
	...
	while True:
		...
		AddTalkListDataIf(not GetEventFlag(9411) or GetEventFlag(9412) == FlagState.On, 1, 15000420, -1)
		# action:15000540:"Level Up"
		AddTalkListDataIf(GetEventFlag(4680) == FlagState.On or GetEventFlag(4699) == FlagState.On, 2, 15000540, -1)
		"""State 36"""
		...
		AddTalkListDataIf(ComparePlayerInventoryNumber(ItemType.Goods, 8590, CompareType.GreaterOrEqual, 1, false) == 1, 8, 15000530, -1)
		...
		AddTalkListData(97, 22021100, -1)
		AddTalkListData(98, 22021101, -1)
		...
		assert not (CheckSpecificPersonMenuIsOpen(1, 0) == true and not CheckSpecificPersonGenericDialogIsOpen(0))
		"""State 8"""
		if GetTalkListEntryResult() == 1:
			...
			"""State 12"""
			OpenPhysickMenu()
			assert not (CheckSpecificPersonMenuIsOpen(21, 0) == true and not CheckSpecificPersonGenericDialogIsOpen(0))
			...
			"""State 13"""
			c1_137()
			assert not (CheckSpecificPersonMenuIsOpen(24, 0) == true and not CheckSpecificPersonGenericDialogIsOpen(0))
		elif GetTalkListEntryResult() == 8:
			"""State 14"""
			OpenEquipmentChangeOfPurposeShop()
			assert not (CheckSpecificPersonMenuIsOpen(7, 0) == true and not CheckSpecificPersonGenericDialogIsOpen(0))
		elif GetTalkListEntryResult() == 9:
			"""State 16"""
			OpenTailoringShop(111000, 111399)
			assert not (CheckSpecificPersonMenuIsOpen(26, 0) == true and not CheckSpecificPersonGenericDialogIsOpen(0))
		...
		elif GetTalkListEntryResult() == 41 and GetEventFlag(120) == FlagState.On and GetEventFlag(11102790) == FlagState.On:
			"""State 21"""
			if not GetEventFlag(2051) and not GetEventFlag(2052):
				"""State 22,31"""
			...
			assert t000001000_x84(action1=FlagState.On)
		elif GetTalkListEntryResult() == 98:
			assert t000001000_x84(action1=FlagState.Off)
		else:
			"""State 4,41"""
...
def t000001000_x32():
	"""State 0,1"""
	if GetEventFlag(1054532702) == FlagState.On:
		"""State 2,4"""
		Label('L0')
		"""State 3"""
		SetWorkValue(0, 0)
	elif GetEventFlag(4698) == FlagState.On:
		"""State 8"""
		Goto('L0')
	elif GetEventFlag(11102790) == FlagState.On:
		"""State 6,7"""
		SetWorkValue(0, 30)
	else:
		"""State 5,9"""
...
def t000001000_x34():
	...
	if not GetEventFlag(4651):
		"""State 3,4"""
		OpenSoul()
		assert not (CheckSpecificPersonMenuIsOpen(10, 0) == true and not CheckSpecificPersonGenericDialogIsOpen(0))
	else:
		"""State 2,1"""
...
def t000001000_x39():
	...
	SetRNGSeed()
	"""State 6"""
	if CompareRNGValue(CompareType.Less, 69) == 1:
		"""State 7,8"""
		SetWorkValue(0, 0)
	elif CompareRNGValue(CompareType.Less, 99) == 1:
		"""State 9,10"""
		SetWorkValue(0, 10)
	else:
		"""State 11,12"""
...
def t000001000_x40():
	...
	while True:
		...
		if GetEventFlag(1054532702) == FlagState.On:
			...
			if call.Done():
				break
			elif GetEventFlag(1054532702) == FlagState.On or GetEventFlag(11102790) == FlagState.On:
				pass
	"""State 8"""
	return 0
...
def t000001000_x41(actionbutton1=_, actionbutton2=_):
	"""State 0,1"""
	if CompareBonfireLevel(0, 0) == true:
		"""State 2,4"""
...
def t000001000_x51(z33=15):
	...
	if not GetEventFlag(12019257):
		...
		if not GetEventFlag(12012711):
			...
			c5_149(GetEventFlag(12019258) == FlagState.On, z33, 21060903, -1, 0, 0)
		elif GetEventFlag(1045379208) == FlagState.On:
			"""State 9"""
		...
		if not GetEventFlag(12012712) or not GetEventFlag(1045379208):
			...
			c5_149(GetEventFlag(12019261) == FlagState.On, z33, 21060912, -1, 0, 0)
		else:
			"""State 11"""
		...
		c5_149(GetEventFlag(12019266) == FlagState.On, z33, 21060921, -1, 0, 0)
	"""State 14"""
	return 0
...
def t000001000_x52():
	...
	if (GetEventFlag(400394) == FlagState.On and not GetEventFlag(12019280) and (GetEventFlag(12012710) == FlagState.On or
		GetEventFlag(12012711) == FlagState.On or GetEventFlag(12012712) == FlagState.On)):
		"""State 4"""
		assert t000001000_x51(z33=15)
	# eventflag:400394:lot:103940:Miniature Ranni
	elif GetEventFlag(400394) == FlagState.On and GetEventFlag(1034509406) == FlagState.On and GetEventFlag(12012713) == FlagState.On:
		"""State 5"""
	...
	"""State 1"""
	c5_149(GetEventFlag(1054532702) == FlagState.On and GetEventFlag(108) == FlagState.On and not GetEventFlag(110), 32, 20010101,
		   -1, 0, 1)
...
def t000001000_x53(z32=15):
	...
	if not GetEventFlag(12019275):
		...
		c5_149(GetEventFlag(12019276) == FlagState.On, z32, 21060931, -1, 0, 0)
	"""State 3"""
	return 0
...
def t000001000_x57(z30=11):
	...
	if not GetEventFlag(4680):
		...
		elif GetEventFlag(4699) == FlagState.On:
			"""State 31"""
			assert t000001000_x46(z31=z30)
		else:
			"""State 5"""
		...
		"""State 6"""
		if (GetEventFlag(10009655) == FlagState.On and not GetEventFlag(105) and not DoesPlayerHaveSpEffect(4270)
		...
		elif GetEventFlag(1042372701) == FlagState.On and not GetEventFlag(1042379203) and not GetEventFlag(10009655):
			"""State 3"""
			c1_149(z30, 21000002, -1, 0, 1)
			SetEventFlag(1042379202, FlagState.On)
		elif GetEventFlag(1042372703) == FlagState.On:
			"""State 28"""
			SetEventFlag(1042379208, FlagState.On)
			c5_149(not GetEventFlag(1042379209), z30, 21000004, -1, 0, 1)
			c5_149(GetEventFlag(1042379209) == FlagState.On, z30, 21000004, -1, 0, 0)
		elif (not GetEventFlag(1042372702) and not GetEventFlag(1042379207) and GetEventFlag(1042379203)
			  == FlagState.On and not GetEventFlag(10009655)):
			"""State 8"""
			c1_149(z30, 21000003, -1, 0, 1)
			SetEventFlag(1042379206, FlagState.On)
		elif GetEventFlag(1046382701) == FlagState.On and not GetEventFlag(1046389202):
			"""State 9"""
			...
			c5_149(GetEventFlag(1046389203) == FlagState.On and not GetEventFlag(1046382700), z30, 21000005, -1,
				   0, 0)
			# action:21000006:"Talk to Melina"
			AddTalkListDataIf(GetEventFlag(1046382700) == FlagState.On, z30, 21000006, -1)
		elif GetEventFlag(1043342700) == FlagState.On and not GetEventFlag(1043349251):
			"""State 10"""
			...
			c5_149(GetEventFlag(1043349252) == FlagState.On and not GetEventFlag(1046382700), z30, 21000007, -1,
				   0, 0)
			# action:21000008:"Talk to Melina"
			AddTalkListDataIf(GetEventFlag(1046382700) == FlagState.On, z30, 21000008, -1)
		elif GetEventFlag(1038502710) == FlagState.On and not GetEventFlag(1038509251):
			"""State 11"""
			...
			c5_149(GetEventFlag(1038509252) == FlagState.On and not GetEventFlag(1046382700), z30, 21000009, -1,
				   0, 0)
			# action:21000010:"Talk to Melina"
			AddTalkListDataIf(GetEventFlag(1046382700) == FlagState.On, z30, 21000010, -1)
		elif GetEventFlag(1043532710) == FlagState.On and not GetEventFlag(1043539251):
			"""State 12"""
			...
			c5_149(GetEventFlag(1043539252) == FlagState.On and not GetEventFlag(1046382700), z30, 21000011, -1,
				   0, 0)
			# action:21000012:"Talk to Melina"
			AddTalkListDataIf(GetEventFlag(1046382700) == FlagState.On, z30, 21000012, -1)
		elif GetEventFlag(11002740) == FlagState.On and not GetEventFlag(11009256):
			"""State 13"""
			SetEventFlag(11009255, FlagState.On)
			c5_149(not GetEventFlag(11009257) and not GetEventFlag(1046382700), z30, 21000013, -1, 0, 1)
			c5_149(GetEventFlag(11009257) == FlagState.On and not GetEventFlag(1046382700), z30, 21000013, -1, 0, 0)
			# action:21000014:"Talk to Melina"
			AddTalkListDataIf(GetEventFlag(1046382700) == FlagState.On, z30, 21000014, -1)
		elif GetEventFlag(1043502700) == FlagState.On and not GetEventFlag(1043509201):
			"""State 25"""
			...
			c5_149(GetEventFlag(1043509202) == FlagState.On and not GetEventFlag(1046382700), z30, 21000015, -1,
				   0, 0)
			# action:21000016:"Talk to Melina"
			AddTalkListDataIf(GetEventFlag(1046382700) == FlagState.On, z30, 21000016, -1)
		elif GetEventFlag(1054552700) == FlagState.On and not GetEventFlag(1054559201):
			"""State 14"""
			...
			c5_149(GetEventFlag(1054559202) == FlagState.On and not GetEventFlag(1046382700), z30, 21000017, -1,
				   0, 0)
			# action:21000018:"Talk to Melina"
			AddTalkListDataIf(GetEventFlag(1046382700) == FlagState.On, z30, 21000018, -1)
		# eventflag:400001:lot:100010:Rold Medallion
		elif (not GetEventFlag(1037519201) and not GetEventFlag(11009260) and not GetEventFlag(400001)
			  and (GetEventFlag(1037512700) == FlagState.On or GetEventFlag(1038512700) == FlagState.On or GetEventFlag(1038502711)
			  == FlagState.On or GetEventFlag(1039512711) == FlagState.On or GetEventFlag(1037522700) == FlagState.On)):
			"""State 17"""
			c1_149(z30, 21000022, -1, 0, 1)
			SetEventFlag(1037519200, FlagState.On)
		elif (GetEventFlag(1036482710) == FlagState.On and GetEventFlag(1036489213) == FlagState.On and GetEventFlag(3940)
			  == FlagState.On and not GetEventFlag(1036489251)):
			"""State 15"""
			c1_149(z30, 21000020, -1, 0, 1)
			SetEventFlag(1036489250, FlagState.On)
		elif (GetEventFlag(1039512710) == FlagState.On and GetEventFlag(1039519209) == FlagState.On and GetEventFlag(1036489210)
			  == FlagState.On and GetEventFlag(3940) == FlagState.On and not GetEventFlag(1039519251)):
			"""State 16"""
			SetEventFlag(1039519250, FlagState.On)
			c1_149(z30, 21000021, -1, 0, 1)
		elif GetEventFlag(11002745) == FlagState.On:
			"""State 29"""
			c5_149(not GetEventFlag(11009266), z30, 21000023, -1, 0, 0)
			c5_149(GetEventFlag(11009266) == FlagState.On, z30, 21000023, -1, 0, 0)
			SetEventFlag(11009265, FlagState.On)
		elif ((GetEventFlag(1054552701) == FlagState.On or GetEventFlag(1052562700) == FlagState.On or GetEventFlag(1052542700)
			  == FlagState.On or GetEventFlag(1051532700) == FlagState.On or GetEventFlag(1052532710) == FlagState.On) and not GetEventFlag(1054539211)):
			"""State 21"""
			SetEventFlag(1054539210, FlagState.On)
			c1_149(z30, 21000026, -1, 0, 1)
		elif GetEventFlag(1054532702) == FlagState.On:
			"""State 22"""
			SetEventFlag(1054539215, FlagState.On)
			c5_149(not GetEventFlag(1054539216), z30, 21000027, -1, 0, 1)
			c5_149(GetEventFlag(1054539216) == FlagState.On, z30, 21000027, -1, 0, 1)
		elif (GetEventFlag(35002730) == FlagState.On or GetEventFlag(35002731) == FlagState.On) and not GetEventFlag(35009351):
			"""State 23"""
			SetEventFlag(35009350, FlagState.On)
			c1_149(z30, 21000028, -1, 0, 1)
		elif GetEventFlag(35002731) == FlagState.On and not GetEventFlag(35009353):
			"""State 24"""
			SetEventFlag(35009352, FlagState.On)
			c1_149(z30, 21000030, -1, 0, 1)
		elif GetEventFlag(35002732) == FlagState.On and not GetEventFlag(35002733):
			"""State 26"""
			c5_149(not GetEventFlag(35009356) and not GetEventFlag(35009357), z30, 21000029, -1, 0, 0)
			c5_149(GetEventFlag(35009356) == FlagState.On or GetEventFlag(35009357) == FlagState.On, z30, 21000029, -1, 0, 0)
			SetEventFlag(35009355, FlagState.On)
		elif GetEventFlag(35002733) == FlagState.On:
			"""State 27"""
			c5_149(not GetEventFlag(35009359), z30, 21000031, -1, 0, 0)
			c5_149(GetEventFlag(35009359) == FlagState.On, z30, 21000031, -1, 0, 0)
			SetEventFlag(35009358, FlagState.On)
		elif GetEventFlag(11109387) == FlagState.On and not GetEventFlag(11009271):
			"""State 19"""
			SetEventFlag(11009270, FlagState.On)
			c1_149(z30, 21000024, -1, 0, 1)
		elif GetEventFlag(1049539207) == FlagState.On and not GetEventFlag(11009276):
			"""State 20"""
...
def t000001000_x58(z31=12):
	...
	if not GetEventFlag(4680):
		"""State 2"""
		if GetEventFlag(4699) == FlagState.On:
			"""State 7"""
...
def t000001000_x59():
	"""State 0"""
	if GetEventFlag(953) == FlagState.On:
		"""State 3,1"""
...
def t000001000_x60():
	"""State 0"""
	if (GetEventFlag(10000851) == FlagState.On and not GetEventFlag(10009655) and not DoesPlayerHaveSpEffect(4270)
		and not DoesPlayerHaveSpEffect(4271) and not DoesPlayerHaveSpEffect(4272) and not DoesPlayerHaveSpEffect(4280)
		and not DoesPlayerHaveSpEffect(4282) and not DoesPlayerHaveSpEffect(4286)):
		"""State 2,3"""
		Label('L0')
		SetEventFlag(4653, FlagState.On)
	elif ((GetEventFlag(3062) == FlagState.On or GetEventFlag(3063) == FlagState.On or GetEventFlag(3064) == FlagState.On or GetEventFlag(3065)
		  == FlagState.On) and not GetEventFlag(10009655) and not DoesPlayerHaveSpEffect(4270) and not DoesPlayerHaveSpEffect(4271)
	...
	# eventflag:400001:lot:100010:Rold Medallion
		  ...
		  == FlagState.On or GetEventFlag(11002742) == FlagState.On or GetEventFlag(11002743) == FlagState.On or GetEventFlag(11002744)
		  == FlagState.On)):
		"""State 5"""
		Goto('L0')
	# eventflag:400001:lot:100010:Rold Medallion
	elif GetEventFlag(9104) == FlagState.On and not GetEventFlag(400001):
		"""State 6"""
		Goto('L0')
	else:
		"""State 1"""
...
def t000001000_x61():
	"""State 0"""
	# eventflag:400001:lot:100010:Rold Medallion
	if GetEventFlag(9104) == FlagState.On and not GetEventFlag(400001):
		"""State 2,1"""
		SetEventFlag(4653, FlagState.On)
	else:
		"""State 3"""
...
def t000001000_x64():
	...
	if GetCurrentStateElapsedTime() > 0.8:
		...
		if not f233():
			pass
		elif GetEventFlag(9001) == FlagState.On:
			"""State 1"""
			Label('L0')
	elif GetEventFlag(9001) == FlagState.On:
		Goto('L0')
...
def t000001000_x67():
	"""State 0"""
	# eventflag:400001:lot:100010:Rold Medallion
	if GetEventFlag(400001) == FlagState.On and not GetEventFlag(108) and not GetEventFlag(11002745):
		"""State 1,3"""
...
def t000001000_x68():
	...
	if GetEventFlag(1054532702) == FlagState.On:
		"""State 1"""
		if GetEventFlag(110) == FlagState.On and not GetEventFlag(1054532703) and not GetEventFlag(9116):
			"""State 3,7"""
			SetEventFlag(9000, FlagState.Off)
			SetEventFlag(9020, FlagState.Off)
			"""State 6"""
...
def t000001000_x69(z27=1, z28=15000370):
	...
	"""State 3"""
	# goods:10010:Golden Seed
	if (ComparePlayerInventoryNumber(ItemType.Goods, 10010, CompareType.GreaterOrEqual, GetWorkValue(1), false) == 1 and GetEstusAllocation(EstusType.HP)
		+ GetEstusAllocation(EstusType.FP) < 13):
		"""State 1"""
...
def t000001000_x70(z25=2, z26=15000380):
	"""State 0,3"""
	# goods:10020:Sacred Tear
	if ComparePlayerInventoryNumber(ItemType.Goods, 10020, CompareType.GreaterOrEqual, 1, false) == 1 and GetTotalBonfireLevel() <= 13:
		"""State 1"""
...
def t000001000_x71(z23=3, z24=15000371):
	...
	"""State 3"""
	# goods:10010:Golden Seed
	if (ComparePlayerInventoryNumber(ItemType.Goods, 10010, CompareType.NotEqual, GetWorkValue(1), false) == 1 or not GetEstusAllocation(EstusType.HP)
		+ GetEstusAllocation(EstusType.FP) < 13):
		"""State 2"""
		# goods:10020:Sacred Tear
		if ComparePlayerInventoryNumber(ItemType.Goods, 10020, CompareType.Less, 0, false) == 1 or not GetTotalBonfireLevel() <= 13:
			"""State 5"""
...
def t000001000_x73(z20=_, z21=_, z22=_):
	"""State 0,1"""
	SetEventFlag(z20, FlagState.On)
	"""State 2"""
	SetEventFlag(z21, FlagState.Off)
	SetEventFlag(z22, FlagState.Off)
	"""State 3"""
	return 0
...
def t000001000_x75(goods3=2010000):
	"""State 0,1"""
	if GetEventFlag(720300) == FlagState.On:
		"""State 2"""
		pass
	else:
		"""State 3,5"""
	...
	if f237() <= 20:
		...
		if call.Get() == 0:
			"""State 9,11"""
			if ComparePlayerInventoryNumber(ItemType.Goods, goods3, CompareType.GreaterOrEqual, GetWorkValue(2), false) == 1:
				"""State 12,13"""
...
def t000001000_x76(goods4=2010100):
	"""State 0,1"""
	if GetEventFlag(720310) == FlagState.On:
		"""State 2"""
		pass
	else:
		"""State 3,4"""
	...
	if f238() <= 10:
		...
		if call.Get() == 0:
			"""State 9,11"""
			if ComparePlayerInventoryNumber(ItemType.Goods, goods4, CompareType.GreaterOrEqual, GetWorkValue(2), false) == 1:
				"""State 12,13"""
...
def t000001000_x80(z1=50, z2=20010001, goods1=2010000, goods2=2010100):
	...
	if f211() > 20000000 and f211() < 28999999:
		...
		assert t000001000_x81(z5=1, z6=2, z7=3, z8=2)
		"""State 8"""
		if ComparePlayerInventoryNumber(ItemType.Goods, goods1, CompareType.NotEqual, GetWorkValue(2), false) == 1:
			"""State 9,15"""
			assert (t000001000_x77(z9=1, z10=1, z11=1, z12=2, z13=2, z14=3, z15=3, z16=3, z17=4, z18=5,
					z19=2, mode1=1))
			"""State 10"""
			if ComparePlayerInventoryNumber(ItemType.Goods, goods2, CompareType.NotEqual, GetWorkValue(2), false) == 1:
				"""State 12"""
				c1_149(z1, z2, -1, 0, 0)
			else:
				"""State 13"""
...
def t000001000_x84(action1=FlagState.On):
	PlayerEquipmentQuantityChange(ItemType.Goods, 67350, -GetItemHeldNumLimit(ItemType.Goods,67350))
	PlayerEquipmentQuantityChange(ItemType.Goods, 67350, GetItemHeldNumLimit(ItemType.Goods,67350))
	ClearQuantityValueOfChooseQuantityDialog()
	OpenChooseQuantityDialog(67350, 22021102)
	assert not (CheckSpecificPersonMenuIsOpen(13, 0) == true and not CheckSpecificPersonGenericDialogIsOpen(0))
	if GetValueFromNumberSelectDialog() >= 0:
		SetEventFlagValue(1051439332,32,GetValueFromNumberSelectDialog())
    ...
    OpenGenericDialog(DialogBoxType.CenterBottom1, 22021103, DialogResult.Left, DialogBoxStyle.OrnateNoOptions, 1)
	assert not CheckSpecificPersonGenericDialogIsOpen(0)
